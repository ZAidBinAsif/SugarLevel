...
import { Mail, Shield, Apple } from "lucide-react"
      ...
      <Card className="w-full max-w-md shadow-xl border-0 bg-white/95 backdrop-blur-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <Button variant="outline" className="w-full h-12 bg-white text-gray-700 border-gray-200 hover:bg-gray-50">
          ...
          <div className="text-center space-y-2">
            ...
            <Link href="/help" className="text-sm text-gray-500 hover:text-gray-700 hover:underline">
              Need help?
            </Link>
          </div>
